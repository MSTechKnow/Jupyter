...
c.Notebook.password='sha1:75fb8928cbc9:77f7ad667fb28a666d32e991ebf08e6ebb7478e5'
...
def post_save_script(model, os_path, contents_manager, **kwargs):
	a="git add "+model['name']
	batcmd="git diff --cached"
	result = subprocess.check_output(batcmd, shell=True)
	l="git commit -a -m '"+str(result)+"'"
	print model['name']
	p="git push https://MSTechKnow:techknows2@github.com/MSTechKnow/Jupyter.git master"
	os.system(a)
	os.system(l)
	os.system(p)
